...
### *Internal Development Team Only — Confidential Technical Documentation*
...
*   `created_at` (DateTime, Default UTC)
*   *Constraint:* `uq_read_messages_user_channel_message` (UniqueConstraint on user_id, channel, message_id).
